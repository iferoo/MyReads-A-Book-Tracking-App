...
You can run a hosted version of the app at [iferoo-myreads/](https://iferoo-myreads.vercel.app/)
...
```
git clone https://github.com/iferoo/MyReads-A-Book-Tracking-App
npm install
```
